...
class CollectionSchemaEntry {
  ...
  CollectionSchemaEntry(this.schema, this.collection, this.endpoint, this.idName);
}
...
class DatabaseService {
  ...
  static final List<CollectionSchemaEntry> collectionSchemas = [
    CollectionSchemaEntry(BuildingTypesIsarSchema, (db) => db.buildingTypesIsars, 'buildingTypes', 'buildingTypeId'),
    CollectionSchemaEntry(EntitiesIsarSchema, (db) => db.entitiesIsars, 'entities', 'entityId'),
    CollectionSchemaEntry(EntityTypeIsarSchema, (db) => db.entityTypeIsars, 'entity-types', 'entityTypeId'),
    CollectionSchemaEntry(UsersIsarSchema, (db) => db.usersIsars, 'users', 'userId'),
    CollectionSchemaEntry(UserProfilesIsarSchema, (db) => db.userProfilesIsars, 'user-profiles', 'userProfileId'),
    CollectionSchemaEntry(TreeIsarSchema, (db) => db.treeIsars, 'trees', 'treeId'),
    CollectionSchemaEntry(TreeLevelIsarSchema, (db) => db.treeLevelIsars, 'tree-levels', 'treeLevelId'),
    CollectionSchemaEntry(TreeRecordDetailTypeIsarSchema, (db) => db.treeRecordDetailTypeIsars, 'tree-record-detail-types', 'treeRecordDetailTypeId'),
  ];
