...
class _EntityTypesScreenState extends State<EntityTypesScreen> {
  ...
  Widget build(BuildContext context) {
    final filteredEntitiTypes = entityTypes.where((entity) {
    ...
    return Scaffold(
            ...
            child: Column(children: [
              ...
              Expanded(
                child: ListView.builder(
                  itemCount: filteredEntitiTypes.length,
                  itemBuilder: (context, index) {
                    final entityType = filteredEntitiTypes[index];
                    return Card(
                      child: ListTile(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: _addOrEditEntityType,
