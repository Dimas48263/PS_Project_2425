...
extension TreeLevelIsarQueryWhereSort
  ...
  QueryBuilder<TreeLevelIsar, TreeLevelIsar, QAfterWhere> anyRemoteId() {
    return QueryBuilder.apply(this, (query) {
...
extension TreeLevelIsarQueryWhere
  ...
  QueryBuilder<TreeLevelIsar, TreeLevelIsar, QAfterWhereClause> remoteIdEqualTo(
      int remoteId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TreeLevelIsar, TreeLevelIsar, QAfterWhereClause> remoteIdBetween(
    int lowerRemoteId,
    int upperRemoteId, {
    bool includeLower = true,
    bool includeUpper = true,
