...
part of 'person_special_needs_isar.dart';
...
extension GetPersonSpecialNeedsIsarCollection on Isar {
  IsarCollection<PersonSpecialNeedsIsar> get personSpecialNeedsIsars =>
      this.collection();
}

const PersonSpecialNeedsIsarSchema = CollectionSchema(
  name: r'PersonSpecialNeedsIsar',
  id: -5713996819736852586,
  properties: {
  ...
  estimateSize: _personSpecialNeedsIsarEstimateSize,
  serialize: _personSpecialNeedsIsarSerialize,
  deserialize: _personSpecialNeedsIsarDeserialize,
  deserializeProp: _personSpecialNeedsIsarDeserializeProp,
  idName: r'id',
  indexes: {
  ...
  links: {
    r'person': LinkSchema(
      id: 2732717262487202564,
      name: r'person',
      target: r'PersonsIsar',
      single: true,
    ),
    r'specialNeed': LinkSchema(
      id: -1449945236220112279,
      name: r'specialNeed',
      target: r'SpecialNeedIsar',
      single: true,
    )
  },
  embeddedSchemas: {},
  getId: _personSpecialNeedsIsarGetId,
  getLinks: _personSpecialNeedsIsarGetLinks,
  attach: _personSpecialNeedsIsarAttach,
  version: '3.1.0+1',
);

int _personSpecialNeedsIsarEstimateSize(
  PersonSpecialNeedsIsar object,
  List<int> offsets,
...
void _personSpecialNeedsIsarSerialize(
  PersonSpecialNeedsIsar object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
PersonSpecialNeedsIsar _personSpecialNeedsIsarDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = PersonSpecialNeedsIsar();
...
P _personSpecialNeedsIsarDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
Id _personSpecialNeedsIsarGetId(PersonSpecialNeedsIsar object) {
  return object.id;
}

List<IsarLinkBase<dynamic>> _personSpecialNeedsIsarGetLinks(
    PersonSpecialNeedsIsar object) {
  return [object.person, object.specialNeed];
}

void _personSpecialNeedsIsarAttach(
    IsarCollection<dynamic> col, Id id, PersonSpecialNeedsIsar object) {
  object.id = id;
  object.person.attach(col, col.isar.collection<PersonsIsar>(), r'person', id);
  object.specialNeed
      .attach(col, col.isar.collection<SpecialNeedIsar>(), r'specialNeed', id);
}

extension PersonSpecialNeedsIsarQueryWhereSort
    on QueryBuilder<PersonSpecialNeedsIsar, PersonSpecialNeedsIsar, QWhere> {
  QueryBuilder<PersonSpecialNeedsIsar, PersonSpecialNeedsIsar, QAfterWhere>
      anyId() {
...
extension PersonSpecialNeedsIsarQueryWhere on QueryBuilder<
    PersonSpecialNeedsIsar, PersonSpecialNeedsIsar, QWhereClause> {
  QueryBuilder<PersonSpecialNeedsIsar, PersonSpecialNeedsIsar,
...
extension PersonSpecialNeedsIsarQueryFilter on QueryBuilder<
    PersonSpecialNeedsIsar, PersonSpecialNeedsIsar, QFilterCondition> {
  QueryBuilder<PersonSpecialNeedsIsar, PersonSpecialNeedsIsar,
...
extension PersonSpecialNeedsIsarQueryObject on QueryBuilder<
    PersonSpecialNeedsIsar, PersonSpecialNeedsIsar, QFilterCondition> {}

extension PersonSpecialNeedsIsarQueryLinks on QueryBuilder<
    PersonSpecialNeedsIsar, PersonSpecialNeedsIsar, QFilterCondition> {
  QueryBuilder<PersonSpecialNeedsIsar, PersonSpecialNeedsIsar,
  ...
  QueryBuilder<PersonSpecialNeedsIsar, PersonSpecialNeedsIsar,
      QAfterFilterCondition> specialNeed(FilterQuery<SpecialNeedIsar> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'specialNeed');
    });
  }

  QueryBuilder<PersonSpecialNeedsIsar, PersonSpecialNeedsIsar,
      QAfterFilterCondition> specialNeedIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'specialNeed', 0, true, 0, true);
    });
  }
}

extension PersonSpecialNeedsIsarQuerySortBy
    on QueryBuilder<PersonSpecialNeedsIsar, PersonSpecialNeedsIsar, QSortBy> {
  QueryBuilder<PersonSpecialNeedsIsar, PersonSpecialNeedsIsar, QAfterSortBy>
      sortByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension PersonSpecialNeedsIsarQuerySortThenBy on QueryBuilder<
    PersonSpecialNeedsIsar, PersonSpecialNeedsIsar, QSortThenBy> {
  QueryBuilder<PersonSpecialNeedsIsar, PersonSpecialNeedsIsar, QAfterSortBy>
      thenByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAt', Sort.asc);
...
extension PersonSpecialNeedsIsarQueryWhereDistinct
    on QueryBuilder<PersonSpecialNeedsIsar, PersonSpecialNeedsIsar, QDistinct> {
  QueryBuilder<PersonSpecialNeedsIsar, PersonSpecialNeedsIsar, QDistinct>
      distinctByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension PersonSpecialNeedsIsarQueryProperty on QueryBuilder<
    PersonSpecialNeedsIsar, PersonSpecialNeedsIsar, QQueryProperty> {
  QueryBuilder<PersonSpecialNeedsIsar, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'id');
    });
  }

  QueryBuilder<PersonSpecialNeedsIsar, DateTime, QQueryOperations>
      createdAtProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PersonSpecialNeedsIsar, String?, QQueryOperations>
      descriptionProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PersonSpecialNeedsIsar, bool, QQueryOperations>
      isSyncedProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PersonSpecialNeedsIsar, int?, QQueryOperations>
      remoteIdProperty() {
    return QueryBuilder.apply(this, (query) {
