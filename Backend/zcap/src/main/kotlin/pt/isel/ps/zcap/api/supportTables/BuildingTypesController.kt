...
class BuildingTypesController(
    ...
    fun getBuildingTypeById(@PathVariable buildingTypeId: Long): ResponseEntity<*> =
    ...
    @PostMapping
    fun addBuildingType(@RequestBody buildingType: BuildingTypeInputModel): ResponseEntity<*> =
