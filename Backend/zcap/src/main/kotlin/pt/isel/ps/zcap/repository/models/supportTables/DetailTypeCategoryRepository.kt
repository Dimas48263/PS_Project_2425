...
@Repository
@Transactional
interface DetailTypeCategoryRepository: JpaRepository<DetailTypeCategory, Long> {
    @Query(
        """
    ...
    fun findValidOnDate(@Param("targetDate") targetDate: LocalDate): List<DetailTypeCategory>
}